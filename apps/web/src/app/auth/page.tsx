      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#1A1A1A] border border-[#333] rounded-2xl p-8">
          ...
          <div className="space-y-3 mb-6">
            <button className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-semibold text-sm py-2.5 rounded-xl hover:bg-gray-100 transition-colors">
            ...
            <button className="w-full flex items-center justify-center gap-3 bg-black text-white border border-[#444] font-semibold text-sm py-2.5 rounded-xl hover:bg-[#111] transition-colors">
            ...
            {mode === 'signup' && (
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#111] border border-[#333] rounded-xl px-4 py-2.5 text-gray-300 text-sm placeholder:text-gray-700 focus:outline-none focus:border-[#F28C28] transition-colors"
                />
              </div>
            )}
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-[#111] border border-[#333] rounded-xl px-4 py-2.5 pr-10 text-gray-300 text-sm placeholder:text-gray-700 focus:outline-none focus:border-[#F28C28] transition-colors"
                />
                <button type="button" onClick={() => setShowPw(p => !p)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-400">
                  {showPw ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                </button>
              </div>
            </div>

            <button type="submit" className="w-full btn-orange text-white font-bold py-3 rounded-xl hover:scale-105 transition-transform text-sm">
